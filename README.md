...
TF-IDF weighting and Cosine Similarity scoring.
Formal evaluation (Precision@k, Recall, MAP) based on arXiv categories.
Optimization via Relevance Feedback (Rocchio Algorithm).
Ablation study on text preprocessing steps (Stopwords, Stemming).
